...
> **Date**: 2026-05-30
> **Status**: Planned
> **Previous Session**: *(vault tracking begins here)*
...
|-----------|--------|------------|-------------------|-----------|
| [[Riven]] | Wes | Elf Ranger/Eldritch Archer — Ruler | Get to the House; find Lyriel | — |
| [[Pavel]] | Darren | Half-Elf Rogue/Beastmaster — Warden | Protect the party; carry Briar forward | — |
| [[Astor]] | Slava | Human Guardian — Counselor | Keep everyone alive; protect what was built | — |
| [[Lucas]] | Jon | Kitsune Oracle/Bard — Magister | Understand what they're walking into | — |
| [[Milo]] | Billy | Halfling Inventor — Treasurer | Get to the House; Rindle freshly repaired | — |
...
1. **Mid-bloom — the Sending arrives.** Riven goes quiet mid-fight.
2. **The decision and the march to [[Thousandbreaths]].** No detours. Urgency is personal now.
3. **[[Thousandbreaths]] montage — two glades land as real encounters.**
4. **[[Glade J — The High Folly]]: [[Ilthuliak]].** The fight that earns the bridge.
5. **The bridge to the [[House at the Edge of Time]].** [[Tarlaxian]] coiled at the far end. Session ends here.

*(Scenes are disposable — ready to throw away.)*
...
5. Nyrissa *suspects* the party has [[Briar]] — the abduction is deliberately timed to draw them into the House before they grow any more powerful.
6. The fey who abducted Lyriel was [[The Wriggling Man]] in disguise — Nyrissa's arcane advisor, wearing a mortal-world face. *(Potential recognition moment in K17 next session.)*

---

## Step 5 — Fantastic Locations

### The Byway — Iron Arch of the Heartless Queen
*(Entry point; Area A of [[Thousandbreaths]])*
- Two women-statues raising swords shaped like [[Briar]] — when [[Pavel]] walks through carrying Briar, the sword and both statues blaze green; [[Nyrissa]] notices
- Eternal twilight; the sun has not moved in centuries
- The woods press close on both sides — off the path, thorns draw blood with every step

### Glade I — The Baleful Lantern
- A beehive-shaped tower lit by decapitated heads used as lanterns, casting sick orange light across the glade
- The anchor is the building itself (AC 30, Hardness 20, HP 400, BT 200) — the glade ends only when the structure falls
- Eight Black Smilodons prowl the perimeter — fey big cats, corrupted First World predators; [[Cat]] is here too

### Glade J — The High Folly
- Mossy stone statues of a petrified First World army surrounding a 300-foot white stone tower
- [[Ilthuliak]] atop the tower — she sees them coming; she opens with *time stop* and the party has one round of uncontested action before she moves
- The acid lake below; a breath weapon (22d6 acid, 100-ft line) from a creature that circles overhead

### The Bridge to the House at the Edge of Time
- A long stone bridge over a lake so dark it has no bottom; the far shore flickers between mountain ranges and open starfield
- [[Tarlaxian]] (elite tarn linnorm, CR 21) coiled at the far end — blocks the bridge, won't pursue into the House
- The [[House at the Edge of Time]] visible across the water: carved laughing, frowning, and frightened faces on every door

---

## Step 6 — Important NPCs

| NPC | Role This Session | Archetype |
|-----|------------------|-----------|
...
|---------|----------|-------|
| Misbegotten Troll (CR 18) | Glade I — Baleful Lantern | Add to Smilodon fight |
| 8× Black Smilodons (CR 14) | Glade I — Baleful Lantern | Fey big cats; [[Cat]] moment for [[Pavel]] |
| The Baleful Lantern (structure) | Glade I | AC 30, Hardness 20, HP 400, BT 200; DC 43 Athletics to collapse |
| [[Ilthuliak]] (CR 21) | Glade J — High Folly | See boss fight prep below |
| Tarlaxian (CR 21, tarn linnorm) | The Bridge | Session-ending obstacle; won't pursue into House |

**Boss fight prep — Ilthuliak:**
- Pre-combat (if she sees them approaching): *time stop* (3 free rounds) → *disappearance* (invisible) + *spell turning* + *true seeing* → positions for breath weapon
- Round 1: Opens with breath weapon (22d6 acid, 100-ft line, DC 44 Reflex)
- In combat: Circles overhead; *reverse gravity*, *black tentacles*, *weird*; swoops into melee when breath recharges
- Fights to the death — no retreat, no negotiation
- Dialog: Play by ear; she's watched every dragonslayer who came for her die
