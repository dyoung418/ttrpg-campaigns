...
> [!info] Two numbering systems
> This vault uses **two independent numbering systems**, and they do **not** line up:
> - **Session numbers** (e.g. *Session 30*) — actual play sessions at the table.
> - **RP document numbers** (e.g. *RP2 — After the Thylacine Fight*) — Discord roleplay exports, numbered in their own sequence.
>
> This timeline is the master record reconciling the two: it summarizes what happened in each session (many of which predate this vault and have no session notes) and places each RP document at its point in the story.

## Session 1 — Feast at Jamandi Aldori's

- **Feast at [[Lady Jamandi Aldori]]'s estate** in [[Restov]], where she extends invitations to the PCs and other groups to enter the Stolen Lands south of Restov and found new kingdoms allied with Restov. Other groups present include [[Maegar Varn]], [[Harrim]], [[Linzi]], [[Tartuccio]], [[Valerie]], [[Amiri]], [[Hannis Drevlev]], and the [[Iron Wraiths|Iron Wraiths]].
- The estate is attacked at night by a group called the **Black Tears**. The PCs are instrumental in defeating them, proving their worth to Jamandi.
- The PCs receive a charter to establish a kingdom in the region known as the **Rostland Hinterlands and Greenbelt**.

## Session 5 — Oleg's Trading Post & the Stag Lord's Bandits
...
In Freehaven's early days the PCs explore, map, and clear the surrounding region:

- **Session 7:** [[Serenko|Fort Serenko]] — an old fort north of [[Nightmarch]]; no dangers; becomes the site of a new town.
- **Session 8:** [[The Temple of the Elk]] — an old shrine guarded by a cursed grizzly bear.
- **Session 9:** Nettles Crossing — a river crossing haunted by the ghost of Nettle, murdered by the Stag Lord's bandits.
- **Session 10:** The **Sootscale Caverns** and the **Old Sycamore Tree** — kobolds (the Sootscales) at war with the mitflits. Their leader had been killed and replaced by [[Tartuccio]] in disguise; the PCs kill Tartuccio and restore the kobolds, easing the peace.
- **Session 12:** The Lonely Barrow — a barrow wight and undead; cleared by the PCs.
- **Session 13:** **[[Lizardfolk Village]]** — on an island in the [[Tuskwater River]] (which borders Nightmarch), north of [[Candlemere Island]]. Led by [[King Vesket]]. The lizardfolk attack, but after the PCs save Vesket from a will-o'-wisp he calls a truce; the village later joins Freehaven as the town of [[Vesket]].
- **Session 18:** **[[Candlemere Island]]** — the PCs clear its will-o'-wisps and find a two-level underground compound, sealing a mysterious passage emitting fear and evil and setting a guard. They meet [[Octavia]].

## Sessions 20–25 — Troubles in the Kingdom
...
- The PCs settle a dispute between loggers and the pixie [[Melianse]], who opposes felling the trees.
...
- **The Hunting Competition**, thrown by the Embeth Travelers led by [[Jameel Visser|Jamal Visser]]. Also present: [[Annamede Belavarah]] (a Pitax bard, no friend of [[King Irovetti]]), and [[Edina Aldori]] with her sister [[Jolia Aldori]] (from [[Restov]], now living in [[Varnhold]]).
  - The PCs aid Edina and Jolia against a Wyvern; **Jolia is killed** in the fight.
  - At the closing dinner, a **Bloom** erupts in the lodge — one of the first of many.
- **The [[Cult of the Bloom]]** — investigation reveals a cult exploiting a scar between the First World and the mortal world to create the Blooms, working toward a monstrous Bloom called the **Cradle of Lamashtu**. The PCs shut down the opening.

## Session 40 — The Varnhold Vanishing & the Nomen
...
- **The Attack on Bronzeshield Hold** — at [[Bronzeshield Hold]], [[Ekundayo]]'s fiancée [[Kisandra Numesti]] arrives from [[Fort Drevlev]] (settlement of [[Hannis Drevlev]]) to warn of an incoming army: trolls of the [[Tiger Lords]] joined by [[Pitax]] mercenaries.
  - Pitax, Drevlev, and the Tiger Lords have allied against Freehaven. The Tiger Lords forced Drevlev to give hostages; he ordered his general [[Terrion Numesti]] to surrender a daughter. Terrion refused and was imprisoned, and Kisandra's **sister** was taken by force — prompting Kisandra to flee and warn the Hold.
  - The PCs break the army, then travel to Fort Drevlev.
...
- The PCs host a competition (jousting, fighting, storytelling) for surrounding kingdoms, including [[Pitax]] under [[King Irovetti]].
...
- After Irovetti's death, strange developments on [[Candlemere Island]] draw the PCs back. They learn how to open the seal on the dungeon's second floor and descend.
- A long, brutal battle follows against the trapped cult and the undead priests who performed the sealing ritual (trapping themselves as well). [[Pavel]] must drop [[Briar]] to survive, then retrieves it; the PCs prevail (helped by Riven joining near the end).
  - *[[RP 23 — Deep Under Candlemere]]* takes place here.

## Session 95 — Kingdom Blooms (A Month of Destruction)
...
- **Lyriel's kidnapping** and tracking down [[Nyrissa]]. → [[Session 100 - She Dropped Your Letter|Session 100]]
...
- [[_sources/processed/Kingmaker Timeline|Kingmaker Timeline]]
